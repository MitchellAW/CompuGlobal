...
@pytest.mark.asyncio
async def test_compuglobal_api_client_get(mock_aioresponse: aioresponses) -> None:
    async with aiohttp.ClientSession() as session:
        url = "https://example.com/test"
        mock_aioresponse.get(url, payload={"ok": True})
...
@pytest.mark.asyncio
async def test_compuglobal_api_client_get_error(mock_aioresponse: aioresponses) -> None:
    async with aiohttp.ClientSession() as session:
        url = "https://example.com/test"
        mock_aioresponse.get(url, status=400)
...
@pytest.mark.asyncio
async def test_compuglobal_api_client_post(mock_aioresponse: aioresponses) -> None:
    async with aiohttp.ClientSession() as session:
        url = "https://example.com/test"
        mock_aioresponse.post(url, payload={"ok": True})
...
@pytest.mark.asyncio
async def test_compuglobal_api_client_post_error(mock_aioresponse: aioresponses) -> None:
    async with aiohttp.ClientSession() as session:
        url = "https://example.com/test"
...
@pytest.mark.asyncio
async def test_compuglobal_api_client_handle_request_get(mock_aioresponse: aioresponses) -> None:
    async with aiohttp.ClientSession() as session:
        url = "https://example.com/test"
        mock_aioresponse.get(url, payload={"ok": True})
...
@pytest.mark.asyncio
async def test_compuglobal_api_client_handle_request_post(mock_aioresponse: aioresponses) -> None:
    async with aiohttp.ClientSession() as session:
        url = "https://example.com/test"
        mock_aioresponse.post(url, payload={"ok": True})
